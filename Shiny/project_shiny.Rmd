...
no_customer <- length(unique(churn$CLIENTNUM))
...
p1<- ggplot(churnNN, aes(x = Income_Category)) +
  ...
  geom_text(aes(y = ..count.. -200, 
            ...
            size = 3)+scale_fill_manual(values=c("#ff7f0e","#1f77b4"))+ theme_gdocs()+ theme(axis.title = element_text(face = "bold", color = "#ff7f0e"))
ggplotly(p1)
```
...
### Existing Customer
```{r Existing}
ex <- ggplot(data =subset(churnNN, Attrition_Flag=="Existing Customer"), aes(x=Customer_Age,fill=Gender)) + geom_bar()+theme_gdocs() + ggtitle("Distrubiton of Age among Existing Customers")+ theme(plot.title = element_text(color = "#1f77b4", size = 15),axis.title = element_text(face = "bold", color = "#ff7f0e"))+scale_fill_manual(values=c("#ff7f0e","#1f77b4"))
...
```{r Attrited}
at <- ggplot(data =subset(churnNN, Attrition_Flag=="Attrited Customer"), aes(x=Customer_Age,fill=Gender)) + geom_bar()+ theme_gdocs() + ggtitle("Distrubiton of Age among Attrited Customers")+ theme(plot.title = element_text(color = "#1f77b4", size = 15),axis.title = element_text(face = "bold", color = "#ff7f0e"))+scale_fill_manual(values=c("#ff7f0e","#1f77b4"))
